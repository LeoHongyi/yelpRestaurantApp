...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"DetailViewHeaderUITableViewCell" bundle:nil]forCellReuseIdentifier:@"DetailViewHeaderUITableViewCell"];
...
{
    if (indexPath.row == DetailVCTableViewRowHeader) {
        DetailViewHeaderUITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"DetailViewHeaderUITableViewCell"];
